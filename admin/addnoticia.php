...
if (isset($_POST['btnsave'])) {
  ...
  if (!isset($errMSG)) {
    $stmt = $DB_con->prepare('INSERT INTO eventos (titulo,descricao,img) VALUES(:utitulo,:udescricao,:upic)');
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <?php //include "./components/cardsMenu.php" ?>
           <!-- Header -->
        <div style="margin-top: -40px;" class="relative  md:pt-16 pb-28 pt-12">
        </div>
                    ...
                    <div class="flex flex-wrap">
                      <div class="w-full px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <input value="<?php echo $titulo; ?>" name="titulo" type="text" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" placeholder="Título da noticia" />
                        </div>
                      </div>
                      ...
                      <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          <textarea class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" name="descricao" type="text" id="default" placeholder="Texto da noticia"><?php echo $descricao; ?></textarea>
                        </div>
                      </div>
