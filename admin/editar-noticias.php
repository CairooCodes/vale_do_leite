...
if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    $stmt_edit = $DB_con->prepare('SELECT * FROM produtos WHERE id =:uid');
...
if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
        ...
        if ($stmt->execute()) {
            echo ("<script>window.location = 'painel-produtos.php';</script>");
        } else {
            $errMSG = "Erro..";
        }
    }
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data" class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 pb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" value="<?php echo $infoNutri; ?>" name="description" placeholder="Descrição do Banner" style="height: 100px;"><?php echo $description; ?></input>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="./uploads/produtos/<?php echo $img1; ?>" onerror="this.src='./assets/img/semperfil.png'" class="img-fluid rounded">
                                        </div>
                                        <div class="col-md-8">
